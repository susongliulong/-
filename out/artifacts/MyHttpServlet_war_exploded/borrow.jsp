    ...
    <%@ include file="top.jsp" %>
  	<div id="main">
		<div class="navigation">
				...
				<div id="readerBlock">欢迎回来&nbsp;:<a href="/book?method=findAllBorrow&page=1">${reader.name }</a> <a href="/logout">注销</a></div>
		</div>
		<div class="img_block">
		...
		<hr class="hr"/>
		<div id="pageControl">
			<a class="pageControl_item">每页<font id="dataPrePage">${dataPrePage }</font>条数据</a>
			<a class="pageControl_item" id="last">最后一页</a>
			<a class="pageControl_item" id="next">下一页</a>
			<div class="pageControl_item"><font id="currentPage">${currentPage }</font>/<font id="pages">${pages}</font></div>
			<a class="pageControl_item" id="previous">上一页</a>
			<a class="pageControl_item" id="first">首页</a>
		</div>
	</div>
